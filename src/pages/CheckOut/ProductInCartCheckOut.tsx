        ...
        <>
            <tr className="bg-gray-100">
                ...
                <td className="ml-10 mr-10 mt-10 w-60 whitespace-normal text-center align-middle">
                    ...
                    <p className="mt-2">
                        ...
                        <span className="font-bold">
                            {data?.atribute[1].value}
                        </span>
                        <br />
                        Màu sắc:{" "}
                        <span className="font-bold">
                            {data?.atribute[0].value}
                        </span>
                    </p>
                </td>
                <td className="mt-5 text-center align-middle font-bold text-red-500">
                    {sale ? <span className="text-sl line-through p-2 text-black font-normal">{formatNumber(data?.price)}đ</span> : ""}
                    {sale ? formatNumber(data?.price - totalPrice) : formatNumber(data?.price)} đ
                ...
                <td className="mt-5 text-center align-middle font-bold">
                    {sale ? formatNumber((data?.price - totalPrice) * quantity?.quantity) : formatNumber(data?.price * quantity?.quantity)}đ
                </td>
            </tr>
