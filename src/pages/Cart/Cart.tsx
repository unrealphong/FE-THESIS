      ...
      <main className="mb-28 pl-36 pr-28">
        <div className="mb-10 mt-20 flex items-center justify-center">
          ...
          <div className="flex items-center">
            ...
            <span className="ml-2 text-xl  font-light">Hoàn Thành Đơn Hàng</span>
          </div>
        </div>
                ...
                <table className="font-bold">
                  ...
                  <tbody className="pt-20">
                    <tr ng-repeat="item in cart" className="relative pb-20">
                      ...
                      <td className="pl-5 pr-5 font-normal">299,000đ</td>
                      ...
                      <td className="pl-4 pr-4 font-bold">299,000đ</td>
