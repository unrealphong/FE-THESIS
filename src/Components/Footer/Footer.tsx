...
function Footer() {
  return (
    <footer className="justify-center text-black">
      <div className="mx-auto flex max-w-7xl flex-wrap">
        <div className="footer-content flex justify-center space-x-20">
          ...
          <div className="b flex w-3/12 flex-col">
            <h2 className="mb-5 text-sm font-bold">ĐĂNG KÝ NHẬN TIN TỪ TOKYOLIFE</h2>
            <div className="mt-2 flex space-x-2">
              ...
              />
              <button className="rounded bg-black p-2 text-white">Đăng ký</button>
            </div>
            <p className="mt-4">
              Cài App nhận{" "}
        ...
        <div className="my-5 w-full border-t border-dashed border-gray-500">
          <span>
            <div className="my-2">
