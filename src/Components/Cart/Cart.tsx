                  ...
                  <tbody style={{ paddingBottom: 17 }}>
                    <tr ng-repeat="item in cart" className="position-relative">
                      ...
                      <td>
                        ...
                        <h6 style={{ fontWeight: "600", paddingBottom: "7px" }}>
                      ...
                      <td>
                        <div className="d-flex">
                          <div
                            ...
                            ng-click="changeQuantity('decrease', $index)"
                          >
                          ...
                          <input
                            ...
                            name="quantity"
                            id="quantity"
                            className="custom-input-quantity text-center"
                            ng-model="cart[$index].quantity"
                            defaultValue={1}
                          />
                          <div
                            className="custom-btn-quantity"
                            ng-click="changeQuantity('increase', $index)"
                          >
                      ...
                      <td
                        className="position-absolute bottom-0 end-0 translate-middle cursor-pointer"
              ...
              <div className="p-3 rounded-3 border shadow-sm d-flex gap-3 flex-column">
                ...
                <div className="custom-dash d-flex flex-column gap-2 pb-3">
                  <div className="d-flex align-items-center justify-content-between">
                    ...
                    <h5 className="mb-0 text-danger fw-bold" ng-if="totalPrice">
                      299,000đ
                    </h5>
                  </div>
                </div>

                <a className="w-100 btn btn-danger" href="#!checkout">
                  Thanh Toán
                </a>
              </div>
            </div>
